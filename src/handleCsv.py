import pandas as pd
from utils import (
    mean_unique_quadruplets,
    mean_group_by,
    saveCsv,
    plot,
    median_unique_quadruplets,
    retrive_data,
    median_group_by,
    sum_metrics_per_language,
    sum_metrics_per_language_and_algorithm,
)
...
dfsum = pd.read_csv("../data/mean_group_by_algorithm.csv")
sumalgo = sum_metrics_per_language(dfsum)

sumalgolang = sum_metrics_per_language_and_algorithm(
    pd.read_csv("../data/meanEmissions.csv")
)

sumalgolang.to_csv("../data/sum_metrics_per_language_and_algo.csv")
