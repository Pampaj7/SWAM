...
int main() {
    try {
        ...
        const size_t minimumLeafSize = 1; // Minimum leaf size (equivalent to min_samples_leaf)
        ...
        // Set the seed for reproducibility (similar to random_state in scikit-learn)
